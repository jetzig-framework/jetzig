...
pub fn base64Decode(allocator: Allocator, input: []const u8) ![]const u8 {
...
pub fn runCommandStreaming(allocator: Allocator, install_path: []const u8, argv: []const []const u8) !void {
...
pub fn runCommandInDir(allocator: Allocator, argv: []const []const u8, dir: Dir, options: RunOptions) !void {
...
fn writeFifoDataToArrayList(allocator: Allocator, list: *ArrayList(u8), fifo: *std.io.PollFifo) !void {
...
pub fn githubUrl(allocator: Allocator) ![]const u8 {
    ...
    var response_storage: ArrayList(u8) = .empty;
    defer response_storage.deinit(allocator);
